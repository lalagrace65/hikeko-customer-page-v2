                    ...
                    <tbody>
                        ...
                        <tr className="border-b">
                            <td className="py-2 px-4 text-center">
                                <Image src="/beginner.png" alt="Beginner" width={100} height={100} className="rounded-lg" />
                            </td>
                        ...
                        <tr className="border-b">
                            <td className="py-2 px-4 text-center">
                                <Image src="/intermediate.png" alt="Intermediate" width={100} height={100} className="rounded-lg" />
                            </td>
                        ...
                        <tr className="border-b">
                            <td className="py-2 px-4 text-center">
                                <Image src="/advanced.png" alt="Advanced" width={100} height={100} className="rounded-lg" />
                            </td>
                        ...
                        <tr className="border-b">
                            <td className="py-2 px-4 text-center">
                                <Image src="/plus-rating.png" alt="+ Rating" width={100} height={100} className="rounded-lg" />
                            </td>
